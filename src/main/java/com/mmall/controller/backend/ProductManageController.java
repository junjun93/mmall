...
public class ProductManageController {
    ...
    @ResponseBody
    public ServerResponse<PageInfo> getManageList(HttpServletRequest httpServletRequest, @RequestParam(value = "pageNum", defaultValue = "1")
    ...
    @ResponseBody
    public ServerResponse<PageInfo> searchProduct(HttpServletRequest httpServletRequest, String productName, Integer productId,
    ...
    @ResponseBody
    public Map richTextImgUpload(HttpServletRequest httpServletRequest, @RequestParam(value = "upload_file", required = false)
